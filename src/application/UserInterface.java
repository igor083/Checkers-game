...
public class UserInterface {
	...
	public static CheckersPosition readCheckersPosition(Scanner sc) {
		try {
			...
			throw new InputMismatchException("Posicao invalida. Valores validos: a1 - h8");
		}
	}
	...
	public static void printMatch(CheckersMatch cm) {
		printBoard(cm.getPieces());
		System.out.println();
		System.out.println("Turn: " + cm.getTurn());
		System.out.println("Esperando o jogador: " + cm.getCurrentPlayer());
